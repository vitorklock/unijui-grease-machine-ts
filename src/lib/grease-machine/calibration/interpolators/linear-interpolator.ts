 ...
 * simplest approach). Simple and exact at calibrated points, but because flow
 * and drip vary exponentially with temperature it carries a small, systematic
 * bias *between* calibration points — kept here as a baseline to contrast
 * against the log-space geometric and Arrhenius strategies.
 */
